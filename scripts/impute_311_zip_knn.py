...
def main() -> None:
    ...
    parser.add_argument("--json-report", type=Path, default=Path("results/knn_zip_validation.json"))
    parser.add_argument("--markdown-report", type=Path, default=Path("results/knn_zip_validation.md"))
